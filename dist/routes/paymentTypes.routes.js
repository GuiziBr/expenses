...
var DeletePaymentTypeService_1 = __importDefault(require("../services/paymentType/DeletePaymentTypeService"));
var GetPaymentTypeService_1 = __importDefault(require("../services/paymentType/GetPaymentTypeService"));
...
paymentTypeRouter.get('/', validateInput_1.validateListRoutes, function (_a, response) {
    var query = _a.query;
    return __awaiter(void 0, void 0, void 0, function () {
        var offset, limit, getPaymentTypeService, _b, paymentTypes, totalCount;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    offset = query.offset, limit = query.limit;
                    getPaymentTypeService = new GetPaymentTypeService_1.default();
                    return [4 /*yield*/, getPaymentTypeService.list(Number(offset), Number(limit))];
                case 1:
                    _b = _c.sent(), paymentTypes = _b.paymentTypes, totalCount = _b.totalCount;
...
paymentTypeRouter.get('/:id', validateInput_1.validateId, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, getPaymentTypeService, paymentType;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                getPaymentTypeService = new GetPaymentTypeService_1.default();
                return [4 /*yield*/, getPaymentTypeService.getById(id)];
            case 1:
                paymentType = _a.sent();
                if (!paymentType)
...
paymentTypeRouter.delete('/:id', validateInput_1.validateId, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deletePaymentTypeService;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                deletePaymentTypeService = new DeletePaymentTypeService_1.default();
                return [4 /*yield*/, deletePaymentTypeService.execute(id)];
            case 1:
                _a.sent();
                return [2 /*return*/, response.status(204).json()];
        }
