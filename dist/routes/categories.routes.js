...
var DeleteCategoryService_1 = __importDefault(require("../services/category/DeleteCategoryService"));
var GetCategoryService_1 = __importDefault(require("../services/category/GetCategoryService"));
...
categoriesRouter.get('/', validateInput_1.validateListRoutes, function (_a, response) {
    var query = _a.query;
    return __awaiter(void 0, void 0, void 0, function () {
        var offset, limit, getCategoryService, _b, categories, totalCount;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    offset = query.offset, limit = query.limit;
                    getCategoryService = new GetCategoryService_1.default();
                    return [4 /*yield*/, getCategoryService.list(Number(offset), Number(limit))];
                case 1:
                    _b = _c.sent(), categories = _b.categories, totalCount = _b.totalCount;
...
categoriesRouter.get('/:id', validateInput_1.validateId, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, getCategoryService, category;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                getCategoryService = new GetCategoryService_1.default();
                return [4 /*yield*/, getCategoryService.getById(id)];
            case 1:
                category = _a.sent();
                if (!category)
...
categoriesRouter.delete('/:id', validateInput_1.validateId, function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, deleteCategoryService;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                deleteCategoryService = new DeleteCategoryService_1.default();
                return [4 /*yield*/, deleteCategoryService.execute(id)];
            case 1:
                _a.sent();
                return [2 /*return*/, response.status(204).json()];
        }
