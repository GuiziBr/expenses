...
expensesRouter.get('/shared', validateInput_1.validateGetExpenses, function (_a, response) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var expensesRepository, owner_id, startDate, endDate, _b, offset, _c, limit, orderBy, orderType, filterBy, filterValue, parsedEndDate, parsedOrderType, _d, expenses, totalCount;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    expensesRepository = typeorm_1.getCustomRepository(ExpensesRepository_1.default);
                    owner_id = user.id;
                    startDate = query.startDate, endDate = query.endDate, _b = query.offset, offset = _b === void 0 ? constants_1.default.defaultOffset : _b, _c = query.limit, limit = _c === void 0 ? constants_1.default.defaultLimit : _c, orderBy = query.orderBy, orderType = query.orderType, filterBy = query.filterBy, filterValue = query.filterValue;
