...
var CreateBankService = /** @class */ (function () {
    ...
    CreateBankService.prototype.parseBank = function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, this.parseBank(existingBank)];
                    case 5:
                        bank = banksRepository.create({ name: name });
                        return [4 /*yield*/, banksRepository.save(bank)];
                    case 6:
                        _a.sent();
                        return [2 /*return*/, this.parseBank(bank)];
                }
            });
        });
    };
    return CreateBankService;
}());
