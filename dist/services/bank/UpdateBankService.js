...
var UpdateBankService = /** @class */ (function () {
    ...
    UpdateBankService.prototype.reactivate = function (bankIdToDelete, bankIdToRestore) {
        return __awaiter(this, void 0, void 0, function () {
            var banksRepository, bankToDelete, bankToReactivate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        banksRepository = typeorm_1.getRepository(Bank_1.default);
                        bankToDelete = banksRepository.create({ id: bankIdToDelete, deleted_at: new Date() });
                        bankToReactivate = banksRepository.create({ id: bankIdToRestore, deleted_at: null });
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, bankToReactivate];
                }
            });
        });
    };
    UpdateBankService.prototype.execute = function (id, name) {
        return __awaiter(this, void 0, void 0, function () {
            var banksRepository, _a, bank, sameNameBank, bankToUpdate, reactivatedBank;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        bankToUpdate = banksRepository.create(__assign(__assign({}, bank), { name: name, updated_at: new Date() }));
                        return [4 /*yield*/, banksRepository.save(bankToUpdate)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                    case 3:
