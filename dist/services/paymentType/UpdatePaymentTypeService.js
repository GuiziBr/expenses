...
var UpdatePaymentTypeService = /** @class */ (function () {
    function UpdatePaymentTypeService() {
    }
    UpdatePaymentTypeService.prototype.reactivate = function (paymentTypeIdToDelete, paymentTypeIdToRestore) {
        return __awaiter(this, void 0, void 0, function () {
            var paymentTypesRepository, paymentTypeToDelete, paymentTypeToReactivate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        paymentTypesRepository = typeorm_1.getRepository(PaymentType_1.default);
                        paymentTypeToDelete = paymentTypesRepository.create({ id: paymentTypeIdToDelete, deleted_at: new Date() });
                        paymentTypeToReactivate = paymentTypesRepository.create({ id: paymentTypeIdToRestore, deleted_at: null });
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, paymentTypeToReactivate];
                }
            });
        });
    };
    UpdatePaymentTypeService.prototype.execute = function (id, description, hasStatement) {
        return __awaiter(this, void 0, void 0, function () {
            var paymentTypeRepository, _a, paymentType, sameDescriptionPaymentType, paymentTypeToUpdate, reactivatedPaymentType;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        paymentTypeToUpdate = paymentTypeRepository.create(__assign(__assign({}, paymentType), { description: description,
                            hasStatement: hasStatement, updated_at: new Date() }));
                        return [4 /*yield*/, paymentTypeRepository.save(paymentTypeToUpdate)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                    case 3:
    ...
    return UpdatePaymentTypeService;
}());
exports.default = UpdatePaymentTypeService;
