...
var UpdateCategoryService = /** @class */ (function () {
    ...
    UpdateCategoryService.prototype.reactivate = function (categoryIdToDelete, categoryIdToRestore) {
        return __awaiter(this, void 0, void 0, function () {
            var categoriesRepository, categoryToDelete, categoryToReactivate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        categoriesRepository = typeorm_1.getRepository(Category_1.default);
                        categoryToDelete = categoriesRepository.create({ id: categoryIdToDelete, deleted_at: new Date() });
                        categoryToReactivate = categoriesRepository.create({ id: categoryIdToRestore, deleted_at: null });
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, categoryToReactivate];
                }
            });
        });
    };
    UpdateCategoryService.prototype.execute = function (id, description) {
        return __awaiter(this, void 0, void 0, function () {
            var categoriesRepository, _a, category, sameDescriptionCategory, categoryToUpdate, reactivatedCategory;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        categoryToUpdate = categoriesRepository.create(__assign(__assign({}, category), { description: description, updated_at: new Date() }));
                        return [4 /*yield*/, categoriesRepository.save(categoryToUpdate)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                    case 3:
