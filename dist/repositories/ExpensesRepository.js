...
(function (FilterByColumn) {
    ...
    FilterByColumn["payment_type"] = "paymentType";
    FilterByColumn["bank"] = "bank";
    FilterByColumn["store"] = "store";
...
var ExpensesRepository = /** @class */ (function (_super) {
    ...
    ExpensesRepository.prototype.getFilterClause = function (filterBy) {
        if (!filterBy)
            return null;
        var filterByColumn = constants_1.default.filterColumns[filterBy];
        return "expenses." + filterByColumn + " = :filterValue";
    };
    ExpensesRepository.prototype.getSharedExpenses = function (_a) {
        var owner_id = _a.owner_id, startDate = _a.startDate, endDate = _a.endDate, _b = _a.offset, offset = _b === void 0 ? constants_1.default.defaultOffset : _b, limit = _a.limit, orderBy = _a.orderBy, orderType = _a.orderType, filterBy = _a.filterBy, filterValue = _a.filterValue;
        return __awaiter(this, void 0, void 0, function () {
            var filterClause, query, _c, expenses, totalCount, typedExpenses;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        filterClause = this.getFilterClause(filterBy);
                        ...
                        if (filterClause)
                            query.andWhere(filterClause, { filterValue: filterValue });
                        return [4 /*yield*/, query.getManyAndCount()];
                    case 1:
                        _c = _d.sent(), expenses = _c[0], totalCount = _c[1];
    ...
    ExpensesRepository.prototype.getPersonalExpenses = function (_a) {
        var owner_id = _a.owner_id, startDate = _a.startDate, endDate = _a.endDate, _b = _a.offset, offset = _b === void 0 ? 0 : _b, limit = _a.limit, orderBy = _a.orderBy, orderType = _a.orderType, filterBy = _a.filterBy, filterValue = _a.filterValue;
        return __awaiter(this, void 0, void 0, function () {
            var searchDateClause, filterClause, query, _c, expenses, totalCount, formattedExpenses;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        query = this.createQueryBuilder('expenses')
                            ...
                            .leftJoinAndSelect('expenses.store', 'stores');
                        if (filterClause)
                            query.where(filterClause, { filterValue: filterValue });
                        query
                            .andWhere(searchDateClause)
                            .andWhere('((expenses.owner_id = :ownerId AND (expenses.personal = true OR expenses.split = true))'
                            + 'OR (expenses.owner_id <> :ownerId AND expenses.personal = false))', { ownerId: owner_id })
                            .orderBy(this.getOrderByClause(orderBy), this.getOrderTypeClause(orderType));
                        return [4 /*yield*/, query.getManyAndCount()];
                    case 1:
                        _c = _d.sent(), expenses = _c[0], totalCount = _c[1];
    ...
    ExpensesRepository.prototype.getBalance = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, personalExpenses, sharedExpenses, owner_id, personalBalance, sharedBalance;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), personalExpenses = _a[0].expenses, sharedExpenses = _a[1].expenses;
