...
exports.ChangePaymentTypeField1621475466451 = void 0;
var typeorm_1 = require("typeorm");
var PaymentType_1 = __importDefault(require("../../models/PaymentType"));
var CreatePaymentTypeService_1 = __importDefault(require("../../services/CreatePaymentTypeService"));
var ChangePaymentTypeField1621475466451 = /** @class */ (function () {
    function ChangePaymentTypeField1621475466451() {
    }
    ChangePaymentTypeField1621475466451.prototype.up = function (queryRunner) {
    ...
    ChangePaymentTypeField1621475466451.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query('ALTER TABLE public.expenses ALTER COLUMN payment_type_id DROP NOT NULL;')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    return ChangePaymentTypeField1621475466451;
}());
exports.ChangePaymentTypeField1621475466451 = ChangePaymentTypeField1621475466451;
