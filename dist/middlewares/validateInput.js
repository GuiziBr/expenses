...
exports.validateListRoutes = exports.validateGetSharedBalance = exports.validateName = exports.validateId = exports.validateGetBalance = exports.validateGetExpenses = exports.validateCreateExpense = exports.validatePaymentType = exports.validateDescription = exports.validateSession = exports.validateUser = void 0;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    schema = Yup.object().shape({
                        ...
                        filterBy: Yup.string().oneOf(Object.keys(constants_1.default.filterColumns)),
                        filterValue: Yup.string().when('filterBy', function (filterBy, filterValue) { return filterBy && filterValue.required(); })
                    });
...
function validateGetSharedBalance(_a, _response, next) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var schema, err_9;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    schema = Yup.object().shape({ month: Yup.number().min(1).max(12).required(constants_1.default.schemaValidationErrors.monthRequired) });
                    return [4 /*yield*/, schema.validate(params)];
                case 1:
                    _b.sent();
                    return [3 /*break*/, 3];
                case 2:
                    err_9 = _b.sent();
                    if (err_9 instanceof Yup.ValidationError)
                        throw new AppError_1.default(err_9.message);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/, next()];
            }
        });
...
exports.validateGetSharedBalance = validateGetSharedBalance;
function validateListRoutes(_a, _response, next) {
    var query = _a.query;
    return __awaiter(this, void 0, void 0, function () {
        var schema, err_10;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    err_10 = _b.sent();
                    if (err_10 instanceof Yup.ValidationError)
                        throw new AppError_1.default(err_10.message);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/, next()];
            }
        });
...
exports.validateListRoutes = validateListRoutes;
